...
$query = "INSERT INTO Event (EventName, EventDesc, EventDate, EventTime, UserID) VALUES ('". $pEventName . "', '" . $pEventDesc . "', '". $pEventDate . "', '". $pEventTime . "', ". /*$row["user_id"]*/24 .")"; //Upload the input fields from the form into the Groups Table
...
//     echo "<br>" . "<br>";
    ...
    if (mysqli_query($conn, $query)) {
        ...
        echo "<a href='get_personal_event.php'>Back to schedule</a>";
