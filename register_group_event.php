...
$query = "INSERT INTO GroupEvent (GrpEventName, GrpEventDescription, GrpEventDate, GrpEventTime, GroupID) VALUES ('". $gEventName . "', '" . $gEventDesc . "', '". $gEventDate . "', '". $gEventTime . "', ". /*$row["user_id"]*/50 .")"; //Upload the input fields from the form into the Groups Table
...
//     echo "<br>" . "<br>";
    ...
    if (mysqli_query($conn, $query)) {
        ...
        echo "<a href='get_group_event.php'>Back to schedule</a>";
