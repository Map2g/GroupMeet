...
$G_Name = $rowG[GroupName];                 //Get name of the group
...
$sqlAll = "SELECT 
            ...
            GrpEventTime
         FROM 
            MyGuests JOIN Groups ON MyGuests.CrowdID = Groups.GroupID 
                    JOIN GroupEvent ON Groups.GroupID = GroupEvent.GroupID
        WHERE
            Groups.UserID = (SELECT user_id FROM Users WHERE Users.email = '" . $_SESSION['Email'] . "')
                AND
